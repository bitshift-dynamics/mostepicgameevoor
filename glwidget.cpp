...

{
    ...
    connect(t, &QTimer::timeout, [=](){
        int passedSeconds= QDateTime::currentSecsSinceEpoch() - secs;
        qDebug() << "Total:" << frames << "fps:" << ((frames * 1.0)/ passedSeconds) << "s:" << passedSeconds;
    });
    t->start(500);
}
...
void GLWidget::initializeGL()
{
    ...
    lightingShaderProgram.addShaderFromSourceFile(QGLShader::Vertex, ":/lightningvertexshader.vert");
    lightingShaderProgram.addShaderFromSourceFile(QGLShader::Fragment, ":/lightningfragmentshader.frag");
...
void GLWidget::paintGL()
{
    ...
    lightingShaderProgram.setUniformValue("ambientColor", QColor(155, 155, 155));
